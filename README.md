# GitHub Pages Demo - GitHub-Pages-Demo-A10 fork by Dwayne Malit

## :bulb: [What is GitHub Pages?](https://docs.github.com/en/github/working-with-github-pages/about-github-pages) :bulb:
...
## :computer: Create a new repository on GitHub :computer:
...
## :computer: Set up Pages :computer:
...
## :computer: URL of the site :computer:
...
## :computer: Cloning a repository :computer:
...
## :computer: Checkout a remote branch :computer:
...
## :computer: Download `mtcars.Rmd` :computer:
...
## :computer: Convert Rmd to HTML :computer:
...
## :computer: Add source code to master branch :computer:
...
## :computer: Add HTML to gh-pages branch :computer:
...
## :computer: View site on browser :computer:
...
## :bulb: Choosing publishing sources :bulb:
